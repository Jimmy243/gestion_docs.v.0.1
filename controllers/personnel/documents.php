...
function getDocuments($url){
 ...
 $db = Connecter();
 try{
 $sql1 = "SELECT documents.IdDoc,NameR,IdD,Id,Docs,document_traitee.DateT,DateEnreg FROM documents LEFT OUTER JOIN  document_traitee ON documents.IdDoc = document_traitee.IdDoc  WHERE Id=?";
