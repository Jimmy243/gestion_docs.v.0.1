              ...
              <div class="card-body">
                ...
                <div class="profile-tabs">
                  <ul class="nav nav-tabs nav-tabs-bottom">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#bottom-tab2" data-toggle="tab">Les Factures non traités <span class="badge badge-pill bg-info float-right" style="color:white">{{tabFacture.length}}</span></a></li>
