        ...
        <div class="content">
          <div class="row">
            ...
            <div class="col-sm-7 col-7 text-right m-b-30">
              <a href="add-department.html" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#ajoutDepart"><i class="fa fa-plus"></i> Add Department</a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">
                      <center>Ajout departement </center>
                    </h5>
